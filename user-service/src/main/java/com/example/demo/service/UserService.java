...
//    private final PasswordEncoder passwordEncoder; // SecurityConfig에서 Bean으로 등록한 PasswordEncoder 주입
//    private final JwtUtil jwtUtil; // <-- 바로 이 필드를 추가하면 됩니다!
//
...
//        user.setRole(UserRoleEnum.USER); // ✨ 가입 시 USER 권한 부여
//
...
//        }
//
//        // 3. 비밀번호 일치 시 JWT 생성하여 반환
//        return jwtUtil.generateToken(user.getEmail(), user.getRole());
//    }
//
//    // --- ✨ 아래 내 정보 조회 메소드를 새로 추가합니다. ---
